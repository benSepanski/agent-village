...
| [M2-topology-checker](M2-topology-checker.md)               | Every declaration the spec says to refuse is refused, with a reason        | Complete | [Pass with follow-ups](../qa/M2-topology-checker.md)        |
| [M3-volumes-and-activations](M3-volumes-and-activations.md) | Declared mounts enforced; session volumes reset; activations begin and end | Complete | [Pass with follow-ups](../qa/M3-volumes-and-activations.md) |
